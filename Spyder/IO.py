...
# In this episode, humans felt compelled to create an interactive environment 
# for their agents. Actions and instructions ensued....
...
for j in range(num_of_iterations):
    for i in range(num_of_agents):
        ...
        if random.random() < 0.5:
            ...
            # y has no attribute (story of my life)
else:
            agents[i]._y = (agents[i]._y - 1) % 100
